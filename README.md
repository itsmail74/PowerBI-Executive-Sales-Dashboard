...
![Power BI](https://img.shields.io/badge/Power_BI-Pro-yellow?style=for-the-badge&logo=power-bi)
...
The report is built upon a robust set of metrics:

* **Dynamic Targets:**
    * 🎯 **Revenue Goal:** Last Year (LY) + 15%
    * 🎯 **Profit Goal:** Last Year (LY) + 10%
* **Key Metrics:**
...
* **Data Modeling:** Star Schema (Fact Sales, Dim Products, Dim Customers).
* **Advanced DAX:** Usage of `CALCULATE`, `SAMEPERIODLASTYEAR`, and `RANKX`.
* **UX/UI:** Custom navigation sidebar and dynamic "Top N" filtering.

---

## 📥 How to Use
1.  Download the `Executive Sales Dashboard.pbix` file.
2.  Open with Power BI Desktop.
3.  Explore the data!

---
*Created by ZEROUAL ISMAIL*
